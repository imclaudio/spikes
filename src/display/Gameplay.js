(function(){
    ...
    Gameplay.prototype = {
        ...
        initialize: function()
        {
            ...
            this.buildWalls();
            this.buildHorizontalSpikes('top');
            this.buildHorizontalSpikes('bottom');
        },
        ...
        destroy: function()
        {
            ...
            for( i; i < _collisions.length; i++ ){
                this.removeChild(_collisions[i]);
            }
        ...
        buildHorizontalSpikes: function( direction )
        {
            var i = 0, s, gap = _size/_maxSpikes;

            for( i; i < _maxSpikes; i++ ) {
                s = new Spike(direction);
                s.x = (gap*i) + _hOffset + ((gap-s.width)/2);
                s.y = direction === 'top' ? _vOffset : _vOffset + _size - s.height;
        ...
        generateSpikes: function()
        {
            ...
            for( i = 0; i < map.length; i++ ){
                ...
                s.y = (i*gap) + (gap/2) - (s.height/2) + _vOffset;
